...
<!--start0506-->
<tr>
<td class="tl"><span class="f_red">*</span> 英文名</td>
<td><input name="category[catename]" type="text" id="catename" size="20" value="<?php echo $catename;?>"/> <?php echo dstyle('category[style]', $style);?> <span id="dcatname" class="f_red"></span></td>
</tr>
<tr>
    <td class="tl">是否为单页类</td>
    <td>
            <input type="radio" name="category[issingle]" value="1" <?php if ( $issingle==1 ) echo 'checked'; ?>> 是&nbsp;&nbsp;&nbsp;&nbsp;
            <input type="radio" name="category[issingle]" value="0" <?php if ( $issingle==0 ) echo 'checked'; ?>> 否
    </td>
</tr>
<tr>
<td class="tl"><span class="f_red">*</span> 跳转地址</td>
<td><input name="category[tzurl]" type="text" id="tzurl" size="60" value="<?php echo $tzurl;?>"/>不是跳转分类请不要填写 <span id="dcatdir" class="f_red"></span></td>
</tr>
<tr>
    <td class="tl"><span class="f_hid">*</span>代表图片</td>
    <td>
            <input name="category[thumb]" id="thumb" type="text" size="60" value="<?php echo $thumb;?>"/>&nbsp;&nbsp;
            <span onclick="Dthumb(<?php echo $MOD['moduleid'];?>, 0, 0, Dd('thumb').value );" class="jt">[上传]</span>&nbsp;&nbsp;
...
<tr >
    <td class="tl"><span class="f_hid">*</span>分类简介</td>
    <td><textarea name="category[summary]" id="summary" class="dsn"><?php echo $summary;?></textarea>
    <?php echo deditor($MOD['moduleid'], 'summary', $MOD['editor'], 700, 150);?><span id="dsummary" class="f_red"></span>
    </td>
</tr>
<tr >
    <td class="tl"><span class="f_hid">*</span>分类内容</td>
    <td><textarea name="category[cont]" id="cont" class="dsn"><?php echo $cont;?></textarea>
    <?php echo deditor($MOD['moduleid'], 'cont', $MOD['editor'], 700, 350);?><span id="dcont" class="f_red"></span>
    </td>
</tr>
<tr>
    <td class="tl">前台是否显示</td>
    <td>
            <input type="radio" name="category[isshow]" value="1" <?php if ( $isshow==1 ) echo 'checked'; ?>> 是&nbsp;&nbsp;&nbsp;&nbsp;
            <input type="radio" name="category[isshow]" value="0" <?php if ( $isshow==0 ) echo 'checked'; ?>> 否
    </td>
</tr>
<!--end0506-->
