...
<td><input name="post[domain]" type="text" id="domain" size="30"/><?php tips('例如http://sell.yige-tech.com/,以 / 结尾<br/>如果不绑定请勿填写');?></td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span> 手机版绑定域名</td>
<td><input name="post[mobile]" type="text" id="mobile" size="30"/><?php tips('例如http://m.sell.yige-tech.com/,以 / 结尾<br/>如果不绑定请勿填写');?></td>
</tr>
</tbody>
</table>
