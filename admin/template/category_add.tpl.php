...
<td><textarea name="category[catename]"  id="catename" style="width:200px;height:100px;overflow:visible;" onblur="get_letter(this.value);"></textarea><?php tips('允许批量添加，一行一个，点回车换行');?><br/><span id="dcatname" class="f_red"></span></td>
</tr>
<tr>
    <td class="tl">是否为单页类</td>
    <td>
            <input type="radio" name="category[issingle]" value="1"> 是&nbsp;&nbsp;&nbsp;&nbsp;
            <input type="radio" checked name="category[issingle]" value="0"> 否
    </td>
</tr>
<tr>
<td class="tl"><span class="f_red"></span> 跳转地址</td>
<td><input name="category[tzurl]" type="text" id="tzurl" size="60" value=""/>不是跳转分类请不要填写 <span id="dcatdir" class="f_red"></span></td>
</tr>
<tr>
...
<tr>
    ...
    <td>
            <input type="radio" checked name="category[isshow]" value="1"> 是&nbsp;&nbsp;&nbsp;&nbsp;
            <input type="radio" name="category[isshow]" value="0"> 否
    </td>
</tr>
<!--end0506-->
<tr>
