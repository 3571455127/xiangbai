...
//echo $ftype.'/'.$itemid;exit;
    $biaodan=get_fielval($ftype,$itemid);
//    print_r($biaodan);
...
?>
<tr>
<td class="tl"><span class="f_hid">*</span> <?php echo $v['title'];?></td>
<td>
...
//            echo $v['value'];
        ...
        if($v[html]=='file' && $v['value']){

            echo "<a href=".$v['value']." target='_blank'>点击查看</a>";

        }else{

           echo  htmlspecialchars_decode( $v['value'] );
