...
if(!$_founder) unset($menu[7],$menu[12],$menu[8],$menu[9]);
if(!$_founder) unset($menu_relate[7],$menu_relate[3],$menu_relate[4],$menu_relate[5],$menu_relate[8],$menu_relate[9],$menu_relate[6]);
?>