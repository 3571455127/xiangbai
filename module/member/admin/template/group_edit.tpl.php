...
<tr>
<td class="tl"><span class="f_red">*</span>会员等级</td>
<td><input type="text" size="2" name="level" id="level" value="<?php echo $level;?>"/> <span class="f_gray">会员等级请填1-9数字</span> <span id="dlevel" class="f_red"></span></td>
</tr>
<tr>
<td class="tl"><span class="f_red">*</span>产品折扣价</td>
<td><input type="text" size="2" name="salesprice" id="salesprice" value="<?php echo $salesprice;?>"/> <span class="f_gray">%;产品折扣价，填写数值</span> <span id="dsalesprice" class="f_red"></span></td>
</tr>
