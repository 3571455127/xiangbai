...
class member {
	...
	function edit($member)	{
		...
		$member = $this->set_member($member);
		$r = $this->get_one();
		$member_fields = array('company','passport','sound','email','qq','wx','wxqr','ali','skype','gender','truename','mobile','department','career','groupid','areaid', 'edittime','vemail','vmobile','vbank','vtruename','vcompany','vtrade','trade','support','inviter','sjcode');
		$misc_fields = array('username','bank','banktype','branch','account','reply','black', 'send');
